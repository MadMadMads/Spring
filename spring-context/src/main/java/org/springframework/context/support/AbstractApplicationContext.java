	...
	public void refresh() throws BeansException, IllegalStateException {
		...
		synchronized (this.startupShutdownMonitor) {
			...
			try {
				...
				// Spring有一个内置的BeanFactoryPostProcessor，
				// 即：ConfigurationClassPostProcessor类，该类实现了BeanDefinitionRegistryPostProcessor类，
				// 所以会执行ConfigurationClassPostProcessor.postProcessorBeanDefinitionRegistry
